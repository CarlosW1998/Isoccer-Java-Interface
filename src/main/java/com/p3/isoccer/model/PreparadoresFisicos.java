...
public class PreparadoresFisicos extends Employee {
    public PreparadoresFisicos(String name, String function, String email, String cpf, String tel, double salario)
    {
